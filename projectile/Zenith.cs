...
namespace Hsmod.projectile
{
    class Zenith : ModProjectile
    {
        ...
        private void AI_182_FinalFractal()
        {
            ...
            float lerpValue1 = Utils.Utils.GetLerpValue(900f, 0.0f, projectile.velocity.Length() * 2f, true);
            ...
            {
                float lerpValue2 = Utils.Utils.GetLerpValue(0.0f, 1f, projectile.localAI[0] / 60f, true);
                ...
                float x = projectile.velocity.Length() + Utils.Utils.GetLerpValue(0.5f, 1f, lerpValue2, true) * 40f;
                float num6 = 60f;
                ...
                Vector2 vector2_2 = (1f - Utils.Utils.GetLerpValue(0.0f, 0.5f, lerpValue2, true)) * new Vector2((float)(((double)projectile.velocity.X > 0.0 ? 1.0 : -1.0) * -(double)x * 0.100000001490116), (float)(-(double)projectile.ai[0] * 0.300000011920929));
                ...
                if (num1 < 1.0)
                {
                    ...
                    int num7 = (int)((double)(1 + (int)((double)projectile.velocity.Length() / 100.0)) * (double)Utils.Utils.GetLerpValue(0.0f, 0.5f, lerpValue2, true) * (double)Utils.Utils.GetLerpValue(1f, 0.5f, lerpValue2, true));
                    if (num7 < 1)
                        num7 = 1;
                ...
                projectile.Opacity = Utils.Utils.GetLerpValue(0.0f, 5f, projectile.localAI[0], true) * Utils.Utils.GetLerpValue(120f, 115f, projectile.localAI[0], true);
            }
        }
