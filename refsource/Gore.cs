	...
	public class Gore
	{
		...
		public void Update()
		{
			...
			if (this.active)
			{
				...
				else if (this.type >= 910 && this.type <= 925)
				{
				...
				else if (this.type != 860 && this.type != 892 && this.type != 893 && (this.type < 825 || this.type > 827))
				{
				...
				else if ((this.type < 910 || this.type > 925) && this.type != 860 && this.type != 892 && this.type != 893)
				{
				...
				else if (this.type >= 910 && this.type <= 925)
				{
					...
					else
					{
						...
						this.rotation = vector5.ToRotation() + 3.14159274f;
						if (this.timeLeft > 0)
						{
							this.timeLeft--;
						}
		...
		public static int NewGore(Vector2 Position, Vector2 Velocity, int Type, float Scale = 1f)
		{
			...
			if (Type >= 411 && Type <= 430 && Main.goreLoaded[Type])
			{
				...
				Gore expr_481_cp_0 = Main.gore[num];
				expr_481_cp_0.velocity.Y = expr_481_cp_0.velocity.Y * ((float)Main.rand.Next(90, 150) * 0.01f);
				Gore expr_4B1_cp_0 = Main.gore[num];
				expr_4B1_cp_0.velocity.X = expr_4B1_cp_0.velocity.X * ((float)Main.rand.Next(40, 90) * 0.01f);
